...
##load dplyr##
library(dplyr)
##Check if the zip file already exists and download if it doesn't##
##Change path to WD##
...
download.file(zurl, "D:/Proyectos/dataset.zip")}
##Uzip the Zip file##
setwd("D:/Proyectos")
unzip("dataset.zip")
##create a table with the features.txt file with rows n and feature##
id <- read.table("D:/Proyectos/UCI HAR Dataset/features.txt", col.names=c("n", "feature"), header = FALSE)
##create a table with the activities.txt file##
act <- read.table("D:/Proyectos/UCI HAR Dataset/activity_labels.txt", col.names=c("No", "Activity"), header = FALSE)
##creating data frames for training data##
str <- read.table("D:/Proyectos/UCI HAR Dataset/train/subject_train.txt", header=FALSE)
trx <- read.table("D:/Proyectos/UCI HAR Dataset/train/X_train.txt", header = FALSE)
try <- read.table("D:/Proyectos/UCI HAR Dataset/train/y_train.txt", header = FALSE)
str$Origin <- c("training")
##creating data frames for test data##
ste <- read.table("D:/Proyectos/UCI HAR Dataset/test/subject_test.txt", header=FALSE)
tex <- read.table("D:/Proyectos/UCI HAR Dataset/test/X_test.txt", header = FALSE)
tey <- read.table("D:/Proyectos/UCI HAR Dataset/test/y_test.txt", header = FALSE)
ste$Origin <- c("test")
...
write.table(tdatamean, "D:/Proyectos/tdatamean.txt", row.names = FALSE)
